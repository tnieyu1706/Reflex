...
{
    public static class ContainerUnityObjectExtensions
    {
        /// <summary>
        ...
        {
            var instanceObject = container.InstantiatePrefab(prefab.gameObject, parent, instantiateInWorldSpace);
        ...
        /// <param name="beforeAwake">The bool define component need in-active</param>
        /// <returns>The newly added and injected Component.</returns>
        public static T AddComponentAndBind<T>(this Container container, GameObject gameObject, bool beforeAwake = true)
            where T : Component
        {
            var component = AddComponentAndBind(container, gameObject, typeof(T), beforeAwake);
