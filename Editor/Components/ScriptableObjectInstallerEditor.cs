...
namespace Reflex.Editor
{
    ...
    public class ScriptableObjectInstallerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("Scriptable Object Bindings", EditorStyles.boldLabel);
            EditorGUILayout.HelpBox("Add ScriptableObjects and select their respective contracts.", MessageType.Info);
        ...
        private void DrawContractsSelection(ScriptableObject targetObject, SerializedProperty contractsProp)
        {
